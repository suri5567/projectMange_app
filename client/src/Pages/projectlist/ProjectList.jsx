...
const ProjectList = () => {
	...
	const loadProjects = async() => {
		try{
		  let res = await axios.get(`https://project-manage-mern-app.onrender.com/projectDetails/getAllData?page=${currentPage}&limit=10&sort=${sortingOption}&searchTerm=${searchTerm}`);
		  setList(res?.data);
		}catch(err){
		  console.log(err)
		}
